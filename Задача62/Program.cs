...
void FillArraySpirally(int[,] array2D)
{
    ...
    int k = 1;
    // задаем будевый массив для проверки заполнения элементов нашего текущего массиваю
    bool[,] visited = new bool[m, n];
    // флаг для выхода из главного цикла.
    bool isEnd = false;
    // начинаем заполнение нашего масива с начала.
    int x = 0, y = 0;
    // заполнение масива по спирали.
    while(!isEnd)
    {
        isEnd = true;
        // движение в право.
        ...
        // заполнения последного элемента массива .
        array2D[x, y] = k;
    }
}
